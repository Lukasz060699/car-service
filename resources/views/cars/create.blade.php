...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Dodawanie samochodu') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('cars.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="rok_produkcji" class="form-control @error('rok_produkcji') is-invalid @enderror" name="rok_produkcji" required autocomplete="rok_produkcji" autofocus>{{ old('rok_produkcji') }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="inf_dodatkowe" class="form-control @error('inf_dodatkowe') is-invalid @enderror" name="inf_dodatkowe" required autocomplete="inf_dodatkowe" autofocus>{{ old('inf_dodatkowe') }}</textarea>
